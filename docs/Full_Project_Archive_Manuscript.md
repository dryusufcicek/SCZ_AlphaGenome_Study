...
## 4. Discussion
This study represents a comprehensive decoding of Schizophrenia risk. By evolving from a "Lead SNP" screen to a deep-learning-based "Credible Set" analysis, we have constructed a unified pathogenic model:
